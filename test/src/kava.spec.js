...
describe('KavaPlugin', function () {
  ...
  it('should reset kava session correctly', () => {
    ...
    kava._model.getBufferTimeSum().should.equal(.0);
    kava._model.getPlayTimeSum().should.equal(.0);
  ...
  it('should reset kava plugin correctly', () => {
    ...
    kava.reset();
    kava._model.getEventIndex().should.equal(1);
    kava._model.getBufferTime().should.equal(.0);
    kava._model.getBufferTimeSum().should.equal(.0);
  ...
  describe('SendAnalytics', () => {
    ...
    it('should send IMPRESSION event', (done) => {
      sandbox.stub(OVPAnalyticsService, "trackEvent").callsFake(
        (serviceUrl, params) => {
